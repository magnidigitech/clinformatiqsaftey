        ...
        <CardContent className="pt-8 px-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <Input value={username} onChange={e => setUsername(e.target.value)} required placeholder="Enter admin username" className="rounded-sm h-11 focus:ring-brand-primary/50 transition-all border-slate-200" />
            </div>
